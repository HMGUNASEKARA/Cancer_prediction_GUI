...
def get_radar_chart(input_data):
    ...
    fig.add_trace(go.Scatterpolar(
        r=[
            ...
            input_data['compactness_mean'],input_data['concavity_mean'],input_data['concave points_mean'],input_data['symmetry_mean'],
...
def add_prediction(input_data):
    ...
    st.write('This app can assist medical professionals in making a diagnosis, but shouid not be used as a substitute for a professional diagnosis')
...
def main():
    ...
    with st.container():
        ...
        st.write('Please connect this app to your cytology lab to help diagnose breast canser from your tissue sample. This app predicts using a machine learning model whether a breast mass is benign or malignant based onthe measurementsit receives from your cytosis lab. You cam also update the sliders in the slidebar')

    col1, col2 = st.columns([4,1]) # Methana 4 1 damme palaweni eka dewani eka wage 4 gunayak wenna one nisa 

    with col1:
        rader_chart = get_radar_chart(input_data)
